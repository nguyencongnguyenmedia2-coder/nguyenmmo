...
export const ChatWidget: React.FC = () => {
  ...
  return (
    <div className={`fixed ${mobileBottomClass} md:bottom-6 right-3 sm:right-6 z-40 flex flex-col items-end transition-all duration-300`}>
      ...
      {isOpen && (
        <div className="mb-3 w-[290px] sm:w-80 bg-[#0D0D14]/95 backdrop-blur-xl border border-white/15 rounded-3xl shadow-2xl p-4 sm:p-5 text-white animate-in fade-in slide-in-from-bottom-5">
